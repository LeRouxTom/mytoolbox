            ...
            <div class="row">
                <figure class="bg-light rounded p-3">
                    <blockquote cite="https://www.huxley.net/bnw/four.html">
                        ...
                        <p>
                            Le code César consiste à substituer une lettre par une autre plus loin dans l'alphabet, c'est-à-dire qu'une lettre est toujours remplacée par la même lettre et que l'on applique le même décalage à toutes les lettres, cela rend très simple le décode d'un message puisqu'il y a 25 décalages possibles.
                        </p>
                    </blockquote>
                    ...
                    <form action="" method="POST" name="cesar">
                        <div class="form-group row">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <div class="input-group">
                                    <input id="key" name="key" type="number" min="0" max="25" class="form-control">
                                </div>
                            </div>
